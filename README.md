...
```bash
curl -fsSL https://raw.githubusercontent.com/iamsabbirahamed/geo-seo-claude/main/install.sh | bash
```

### Manual Install

```bash
git clone https://github.com/iamsabbirahamed/geo-seo-claude.git
cd geo-seo-claude
./install.sh
```
...
curl -fsSL https://raw.githubusercontent.com/iamsabbirahamed/geo-seo-claude/main/install-win.sh | bash
